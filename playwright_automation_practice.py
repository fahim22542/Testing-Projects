...
# === CONFIGURABLE LIMITS ===
FILTER_LIMITS = {
    "location_1": None,        # e.g. 2 to limit, None for unlimited
    "location_2": None,
    "location_3": None,
    "location_4": None,
    "location_5": None
...
def run_comprehensive_test(playwright: Playwright) -> None:
    ...
    try:
        page.goto("https://dummywebsite.com/") # for website obfuscation
        page.get_by_role("textbox", name="Email").fill("example@mail.com")
        page.get_by_role("textbox", name="Password").fill("example@pass")
        ...
        for i, chain in enumerate(complete_chains, 1):
            ...
            if verification['invalid_records']:
                print("Issues found:")
                for invalid in verification['invalid_records'][:3]:
